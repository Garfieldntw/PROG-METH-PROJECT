...
public class PlayerCanvas extends Canvas {
	...
	public PlayerCanvas(double width, double height) {
		...
		this.p1 = new Player("Player 1", (50 * 1) + 1, (50 * 4) + 1, 3, Direction.RIGHT);
		this.p2 = new Player("Player 2", (50 * 15) + 1, (50 * 4) + 1, 3, Direction.LEFT);
		setupMove();
